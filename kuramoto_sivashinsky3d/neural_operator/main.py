...
def main(args):
    ...
    save_dir = os.path.join(args.data_path, f"log_model/experiment_results_model_{args.model}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--device', type=str, default="cuda:3", help="Device to use: cuda or cpu")
    parser.add_argument('--data_path', type=str, default="/home/zhangrui/zhangruiC/SSNO/kuramoto_sivashinsky3dv2",
                         help="Base data directory")
    parser.add_argument('--dim', type=int, default=1, help="Input/Output dimension (channels)")
    parser.add_argument('--size', type=int, default=64, help="Spatial resolution after downsampling")
    ...
    parser.add_argument('--use_fx', type=int, default=0, help="Whether to use the f_x path")
    parser.add_argument('--anti_alias_ratio', type=float, default=0.83, help="Anti-aliasing ratio")
    ...
    parser.add_argument('--num_step2', type=int, default=2, help="Prediction steps per training iteration")

    # Sparse regularization
    parser.add_argument('--sparse_coeff', type=float, default=0)
