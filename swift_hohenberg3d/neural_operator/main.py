...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default="/home/zhangrui/zhangruiC/SSNO/swift_hohenberg3dv2",
    ...
    parser.add_argument('--k_num', type=int, default=16)
    ...
    parser.add_argument('--num_step2', type=int, default=1, help="Prediction steps per training iteration")
