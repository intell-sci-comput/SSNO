...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default="/home/zhangrui/zhangruiC/SSNO/kuramoto_sivashinsky",
    ...
    parser.add_argument('--sparse_coeff', type=float, default=1e-5)
