...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default="/home/zhangrui/zhangruiC/SSNO/swift_hohenberg",
    ...
    parser.add_argument('--use_pi', type=int, default=0, help="Whether to use the PI path")
    ...
    parser.add_argument('--anti_alias_ratio', type=float, default=0.8, help="Anti-aliasing ratio")
