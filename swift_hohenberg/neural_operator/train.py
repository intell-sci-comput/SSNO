...
def train(args, net):
    ...
    data_dict_path = os.path.join(data_path, f'log/sh_train.txt')
    ...
    train_data = torch.load(os.path.join(data_path, f'dataset/sh_train.pt')).float()[:num_train,
                 ::int(data_ratio // model_ratio), ::sub_x, ::sub_x, :].to(device)
    test_data = torch.load(os.path.join(data_path, f'dataset/sh_test.pt')).float()[...,
                 ::int(data_ratio // model_ratio), ::sub_x, ::sub_x, :].to(device)
    val_data = torch.load(os.path.join(data_path, f'dataset/sh_val.pt')).float()[...,
                 ::int(data_ratio // model_ratio), ::sub_x, ::sub_x, :].to(device)
